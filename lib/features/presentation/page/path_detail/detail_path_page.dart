...
class _DetailPathPageState extends State<DetailPathPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: _appBarDetailRole(role),
      body: Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
          child: ListView(
            children: [
              _headerImagePath(role, context),
              const SizedBox(
                height: 10,
              ),
              toolsPath(role),
  ...
  Container _headerImagePath(Roles role, BuildContext context) {
    return Container(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  AppFormat.formatPathName(role.name ?? "Learning Path"),
  ...
  AppBar _appBarDetailRole(Roles role) {
    return AppBar(
      elevation: 0,
