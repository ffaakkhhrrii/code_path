...
class _AddNewsPageState extends State<AddNewsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<CRoles>(builder: (controller) {
          return ListView(
            children: [
              Padding(
                ...
                child: Form(
                    ...
                    child: Column(
                      children: [
                        baseTextFormField("Title", titleTextController),
                        ...
                        baseTextFormField("Description", descriptionTextController,TextInputType.multiline),
                        const SizedBox(height: 10,),
  ...
  TextFormField baseTextFormField(
      String name, TextEditingController controller, [TextInputType? type = TextInputType.text]) {
